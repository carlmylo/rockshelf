...
import { getRB3SaveDataFile, readUserConfigFile, sendSmallMessage, useHandler } from '../core.exports'
...
export const rpcs3GetSaveDataStats = useHandler(async (win, __): Promise<false | ParsedRB3SaveData> => {
  ...
  if (!userConfig) {
    sendSmallMessage(win, { method: 'rpcs3GetSaveDataStats', type: 'error', code: 'noUserConfigFile' })
    return false
  }

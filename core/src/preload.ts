...
export const rockshelfAPI = {
  ...
  extractMultitrackFromSong: async (packagePath: string, song: RB3CompatibleDTAFile): ReturnType<typeof extractMultitrackFromSong> => await invoke('extractMultitrackFromSong', packagePath, song),

...
export const rockshelfAPI = {
  ...
  selectImageForPackage: async (defaultPath: string): ReturnType<typeof selectImageForPackage> => await invoke('selectImageForPackage', defaultPath),
